...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\jclsm\IdeaProjects\Python_Projects\task_manager_pro'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\jclsm\IdeaProjects\Python_Projects\task_manager_pro\Scripts\deactivate.nu'
